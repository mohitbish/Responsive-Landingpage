    ...
    <div className="max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4">
      ...
      <div className="flex flex-col h-full justify-center">
        ...
        <p className="text-2xl py-6">
          Are you ready to escape the ordinary and embrace a private island
          holiday like no other?
        </p>
        <p className="pb-6">
          Welcome to your exclusive private island retreat, a hidden gem nestled
          amidst the azure waters of the sparkling ocean. As you venture onto
          our pristine shores, leave the worries of the world behind and embrace
          a blissful escape like no other.
        </p>
        <div>
          <button className="border-black mr-4 hover:shadow-xl rounded-2xl px-2 py-2 ">
            Learn More
          </button>
          <button className="bg-black text-white border-black hover:shadow-xl rounded-2xl px-2 py-2">
            Book Your Trip
          </button>
        </div>
      </div>
