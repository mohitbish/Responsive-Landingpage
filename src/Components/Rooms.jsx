...
const Rooms = () => {
  return (
    <div className="max-w-[1400px] h-[900px] bg-blue-100 mx-auto my-20 pt-16 lg:mb-[20%] md:mb-[35%] px-4 grid lg:grid-cols-3 gap-4">
      <div className="lg:top-20 relative lg:col-span-1 col-span-2">
        <h3 className="text-2xl font-bold">Fine Interior Rooms</h3>
        <p className="pt-4">
          Escape to our enchanting resort, where beautiful rooms redefine luxury
          and tranquility.
        </p>
      </div>
